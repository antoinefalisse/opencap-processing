...
do
    ...
    sshpass -p 'Stanford!' rsync -avz --ignore-existing "/mnt/c/Users/antoi/Documents/MyRepositories/opencap-processing-fork/Data/Benchmark/$n/" clarkadmin@171.65.102.146:Documents/MyRepositories_Antoine/opencap-processing-fork/opencap-processing/Data/Benchmark/$n 
