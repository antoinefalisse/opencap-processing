...
#%% User inputs
saveErrors = True
fieldStudy = False # True for both LabValidation and FieldStudy results. False for only LabValidation results.
saveFigures = False
...
all_motions = ['squats', 'squatsAsym', 'walking', 'walkingTS', 'STS', 'STSweakLegs']
